...
public class consultarUser extends AppCompatActivity {
    ...
    ConexionSQLiteHelper conn; //carga acceso a la base de datos
    ...
    private void actualizarUsuario() {
        SQLiteDatabase db=conn.getWritableDatabase();//abre base de datos
        String[] parametros={campoId.getText().toString()};//dato a consultar
    ...
    private void consultar() {
        SQLiteDatabase db=conn.getReadableDatabase();
        String[] parametros={campoId.getText().toString()};// parametros para hacer la consulta
        String[] campos={Utilidades.CAMPO_NOMBRE,Utilidades.CAMPO_TELEFONO};//parametros ke devuelve la consulta
